...
municipios_vale = [
    ...
    'PIQUETE', 'POTIM', 'QUELUZ', 'REDENÇÃO DA SERRA', 'ROSEIRA', 'SANTA BRÍGIDA',
    'SANTA ISABEL', 'SÃO BENTO DO SAPUCAÍ', 'SÃO JOSÉ DOS CAMPOS', 'SÃO LUÍS DO PARAITINGA',
    'SÃO SEBASTIÃO', 'SILVEIRAS', 'TAUBATÉ', 'TREMEMBÉ', 'UBATUBA', 'VARGEM'
]
